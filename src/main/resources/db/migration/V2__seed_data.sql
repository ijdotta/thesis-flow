-- V2 Seed data for thesis-flow
-- Deterministic UUIDs so that external integrations / docs can reference stable public IDs.
-- NOTE: If you rerun locally, truncate tables first or start with a clean database.
...
-- STUDENTS (link to persons Alice, Bob)
INSERT INTO student (public_id, person_id, student_id, email)
VALUES
...
-- PROFESSORS (link to persons Carol, David)
INSERT INTO professor (public_id, person_id, email)
VALUES
...
-- PROJECT
INSERT INTO project (public_id, title, type, initial_submission, completion, application_domain_id, created_at, updated_at)
VALUES (
...
INSERT INTO project_participant (public_id, project_id, person_id, participant_role)
VALUES
